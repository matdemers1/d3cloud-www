...
/** The width a page's sections lay out in. */
export const WRAP = 'mx-auto w-full max-w-7xl px-4 sm:px-8 lg:px-16 xl:px-24';

/**
 * A page section: its label (and heading) in a slim column beside the content
 * where there is room for both, above it where there is not.
 */
